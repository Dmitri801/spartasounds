...
class Manage extends Component {
  ...
  renderManageComponent = () => {
    ...
    switch (componentToRender) {
          ...
          <div className="form_container">
            <div className="manage_card">
              ...
              <div className="manage_btn_container">
                ...
                <CustomButton
                  onClick={() => this.setState({componentToRender: "Category"})}
                  color="secondary"
                  variant="contained"
                  size="large"
                  fullWidth
                ...
                <CustomButton
                 onClick={() => this.setState({componentToRender: "Destroy"})}
                 color="secondary"
                 variant="outlined"
                 size="large"
                >Destroy
      ...
      case "Genre":
        return (
          <ManageGenre back={this.backToIndex} />
        )
      case "Category":
       return (
         <ManageCategory back={this.backToIndex} />
       )
      case "Destroy":
       return (
         <DestroyProduct back={this.backToIndex} />
       )
      default:
        return (
          <div>
